<?php
  ...
  $user_id1 = 12; //$_GET['user_id'];      
  // $today = date("Y-m-d");
   $today = date('2020-09-30');
  // $today = $_GET['date'];
  $tomorrow = date("Y-m-d", strtotime($today.'+1 day'));
  $face_id='7ac31c9b-183c-4a8e-ad34-1c036348dd11';//$_POST['face_id'];
  $id=0;
...
<div class="all">
    ...
    <div class="ue2">
        ...
        <p>命中ポイント：<?php  echo $meichu_point;?></p> <!--  if(!empty($meichu_point))-->
    </div>
    <div class="sita1">
                <br></br><hr>
                <p>次回の目標値</p>      
